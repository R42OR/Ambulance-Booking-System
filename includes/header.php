...
?>
 <div class="login_btn"> 
 <a href= <?php include('logout.php');?> >Reset</a><br>
 <?php include('login.php');?>
 <a href="includes\#login.php" class="btn btn-xs uppercase" data-toggle="modal" data-dismiss="modal">Login / Register</a> </div>
	 ...
	 echo htmlentities($result->FullName); }}?><i class="fa fa-angle-down" aria-hidden="true"></i></a>
      ...
      <div class="collapse navbar-collapse" id="navigation">
        <ul class="nav navbar-nav">
          ...
          <li><a href="car-listing.php">Available Ambulances</a>
