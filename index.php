      ...
      <div class="row">
        <div class="col-md-5 col-md-push-7">
          <div class="banner_content">
           ...
           <a href="#12345" class="btn">BOOK NOW<span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></a> </div>
        </div>
      </div>
    </div>
  </div>
...
<section id="banner2">
  <div>
    <br>
    <br>
  <marquee behavior="scroll" direction="right" scrollamount="80">
    <img src="https://media.giphy.com/media/4NtPFwZh48kNn7EOg3/giphy.gif">
    </marquee>
    <br>
  </div>
</section>
...
<section class="section-padding gray-bg">
  <div class="container">
    <div id="12345" class="section-header text-center">
      <h1> <a href="#logout.php" >Reset</a></h1>
      <h2>Find the Best <span>CareForYou</span></h2>
    ...
    <div class="row"> 
      ...
      <div class="recent-tab">
        <ul class="nav nav-tabs" role="tablist">
          <li role="presentation" class="active"><a href="#resentnewcar" role="tab" data-toggle="tab">List of Avalable Ambulance</a></li>
        </ul>
      </div>
